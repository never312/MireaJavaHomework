...
public class Bed extends Furniture {
    ...
    public Bed(String modelName, double height, double width, double depth, int price, int personCount, int maxWeight, String mainMaterial, String mattressMaterial) {
