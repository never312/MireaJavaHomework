package ru.mirea.ikbo2821.aleksandrov.gui;
...
import ru.mirea.ikbo2821.aleksandrov.exceptons.EmptyOrderListException;
import ru.mirea.ikbo2821.aleksandrov.exceptons.NoFreeTablesException;
import ru.mirea.ikbo2821.aleksandrov.menu.Dish;
import ru.mirea.ikbo2821.aleksandrov.menu.Drink;
import ru.mirea.ikbo2821.aleksandrov.menu.DrinkTypeEnum;
import ru.mirea.ikbo2821.aleksandrov.orders.InternetOrder;
import ru.mirea.ikbo2821.aleksandrov.orders.Order;
import ru.mirea.ikbo2821.aleksandrov.orders.TableOrder;
import ru.mirea.ikbo2821.aleksandrov.orders.managers.InternetOrderManager;
import ru.mirea.ikbo2821.aleksandrov.orders.managers.TableOrderManager;
...
public class Controller implements Runnable{
    ...
    public void addToOrder(String[] arr, int tNum){
        ru.mirea.ikbo2821.aleksandrov.menu.MenuItem mi;
        try{
            if(arr.length == 3)
    ...
    public void addOrder(String[][] ord){
        ru.mirea.ikbo2821.aleksandrov.menu.MenuItem[] itms = new MenuItem[ord.length];
